...
export const featuredSeries: FeaturedSeries[] = [
    { id: 1, title: 'The Family Series', parts: 3, pattern: 'bg-emerald-900', color: 'bg-emerald-900' },
    { id: 2, title: 'Stories of the Prophets', parts: 3, pattern: 'bg-amber-900', color: 'bg-amber-900' },
    { id: 3, title: 'Ramadan Prep 2026', parts: 2, pattern: 'bg-slate-900', color: 'bg-slate-900' },
    { id: 4, title: 'Financial Ethics', parts: 3, pattern: 'bg-stone-900', color: 'bg-stone-900' },
];
...
export const audioTracks: AudioTrack[] = [
    ...
    { id: 3, title: 'Stories of Prophet Ibrahim - Part 1', speaker: 'Sheikh Abdullah Smith', src: 'https://server8.mp3quran.net/jbrl/003.mp3' },
    { id: 4, title: 'Stories of Prophet Ibrahim - Part 2', speaker: 'Sheikh Abdullah Smith', src: 'https://server8.mp3quran.net/jbrl/004.mp3' },
];
...
export const allKhutbahs: Khutbah[] = [
    ...
    { id: 11, title: 'Financial Ethics - Riba', speaker: 'Sheikh Omar Hassan', date: 'Nov 15, 2025', hijriDate: 'Jumada I 14, 1447', duration: '29:30', tags: ['Finance', 'Ethics'], audioUrl: 'https://server8.mp3quran.net/jbrl/011.mp3', seriesId: 4 },
];
