            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                        Building bridges with our neighbors through service, dialogue, and compassion.
                    </p>
                ...
                {/* Wide Hero Image */}
                <motion.div
                    className="relative w-full aspect-[21/9] rounded-3xl overflow-hidden shadow-lg"
